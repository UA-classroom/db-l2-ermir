...
import { registerProvider, login, getCurrentUser } from '@/lib/auth';
...
const registerSchema = z.object({
    ...
    phone_number: z.string().min(1, 'Phone number is required for providers'),
...
export default function ProviderRegisterPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0f0f1a] flex items-center justify-center py-12 px-4 relative overflow-hidden">
            ...
            <div className="absolute top-1/3 left-1/4 w-96 h-96 bg-[#d4af37]/5 rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-[#d4af37]/10 rounded-full blur-3xl"></div>
            ...
            <div className="relative z-10 max-w-md w-full">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="mt-2 text-gray-400 font-light">
                        List your premium services
                    </p>
                </div>

                {/* Benefits Box */}
                <div className="mb-6 p-5 bg-gradient-to-r from-[#d4af37]/10 to-transparent border border-[#d4af37]/20 rounded-xl">
                    <h3 className="font-light text-[#d4af37] mb-3">✦ Partner Benefits</h3>
                    <ul className="text-sm text-gray-400 space-y-2 font-light">
                        <li className="flex items-center gap-2">
                            <span className="text-[#d4af37]">◈</span> Access to discerning clientele
                        </li>
                        <li className="flex items-center gap-2">
                            <span className="text-[#d4af37]">◈</span> Elegant booking management
                        </li>
                        <li className="flex items-center gap-2">
                            <span className="text-[#d4af37]">◈</span> Premium business tools
                        </li>
                    </ul>
                </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="tel"
                                className={`w-full px-4 py-3 bg-[#16213e]/50 border rounded-lg text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#d4af37]/50 focus:border-[#d4af37]/50 transition-all ${errors.phone_number ? 'border-red-500/50' : 'border-white/10'
                                    }`}
                                placeholder="+46 70 123 4567"
                            />
                            {errors.phone_number && (
                                <p className="mt-2 text-sm text-red-400">{errors.phone_number.message}</p>
                            )}
                        </div>
                ...
                <p className="mt-6 text-center text-sm text-gray-500">
                    ...
                    <Link href="/register/customer" className="text-[#d4af37] hover:text-[#e8c547]">
                        Register as Guest
                    </Link>
                </p>
            </div>
